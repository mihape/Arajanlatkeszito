...
async function runSmokeBackup(mode = "write") {
  ...
  if (mode === "write") {
    ...
    const imported = await data.importState(createSmokeImportedState(baseState, backupDate));
